...
import DashboardLayoutDono from "@/layout/dashboard/DashboardLayoutDono.vue";
...
const Gerentes = () => import(/* webpackChunkName: "dashboard" */"@/pages/ListGerente.vue");
...
const routes = [
  ...
  },
  {
    ...
    redirect: '/pdvs',
    name: 'DONOS PONTO DE VENDAS',
    children: [
      {
        path: '/pdvs',
        name: 'DONOS PONTO DE VENDAS',
        components: { default: Gerentes }
      }
    ]
  },
